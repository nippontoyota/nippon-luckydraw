                ...
                <tbody key={group.branch.id} className="divide-y divide-gray-100">
                  <tr className="bg-slate-100">
                    <td
                      colSpan={6}
                      className={`px-4 py-3 ${
                        groupIndex > 0 ? "border-t-4 border-t-slate-200" : ""
                      }`}
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <span className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-slate-800 text-white shrink-0">
                        ...
                        <div className="min-w-0 flex items-baseline gap-2 flex-wrap">
                          ...
                          <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[11px] font-medium bg-white text-slate-600 border border-slate-200 tabular-nums">
                  ...
                  {group.entries.length === 0 ? (
                    ...
                    group.entries.map((entry) => {
                      ...
                      return (
                        ...
                        >
                          <td className="pl-6 pr-4 py-3 min-w-0 max-w-[180px] border-l-2 border-l-slate-200">
                            <div
